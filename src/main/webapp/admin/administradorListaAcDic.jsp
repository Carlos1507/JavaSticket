...
<body>
<!--Botón flotante "+" para celebridad-->
<a href="registrarCelebridad.html" class="btn-float">
    <i class="fas fa-plus my-float"></i>
</a>

<!--Cabecera principal centro cultural-->
<nav
...
<main>
    ...
    <div class="row justify-content-center align-items-start my-2">
        ...
        <div class="col-md-2 text-center mt-2">
            <img
                    class="w-100"
                    src="../resources/assets/img/magaly.jpg"
    ...
    <div class="row justify-content-center align-items-start my-2">
        ...
        <div class="col-md-2 text-center mt-2">
            <img
                    class="w-100"
                    src="../resources/assets/img/bong.jpg"
                    style="max-height: 220px; max-width: 250px"
            />
        </div>
        <!--Precio y Stock-->
    ...
    <div class="row justify-content-center align-items-start my-2">
        ...
        <div class="col-md-2 text-center mt-2">
            <img
                    class="w-100"
                    src="../resources/assets/img/benedict.jpg"
                    style="max-height: 220px; max-width: 250px"
            />
        </div>
        <!--Precio y Stock-->
